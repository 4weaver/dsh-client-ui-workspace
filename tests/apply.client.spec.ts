...
import { apply, inject } from 'dsh-client-ui-forkspace/client'
import type { WorkspaceBrowserInjected, WorkspacePickerInjected } from 'dsh-client-ui-forkspace/client'
