window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$2 = "dsh-client-ui-forkspace/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-client-ui-forkspace";
		...
		*/
		...
		const tagId$1 = "dsh-client-ui-forkspace/WorkspacePicker.module.css";
		...
		*/
		...
		const tagId = "dsh-client-ui-forkspace/WorkspaceBrowser.module.css";
