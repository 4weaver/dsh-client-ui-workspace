window.__ModuleLoader__.load({
	id: "@deepseek-ai/dsh-client-ui-forkspace",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		function rootHuman(byId, archived, id) {
			let current = byId[id]?.parentId;
			for (let hops = 0; current !== void 0 && hops < ROOT_WALK_LIMIT; hops += 1) {
		...
		function forestOf(sessions, byId, archived, descendants, pendingInteractions) {
			...
			for (const node of sessions) {
				...
				if (bucket === void 0) kids.set(parent, [summary]);
		...
		*/
		function deriveGroupForest(list, workspaces, archivedSessionIds, pendingInteractions, view) {
			const archived = new Set(archivedSessionIds);
			const byId = list.byId;
			const descendants = indexSubagentDescendants(byId);
			return deriveGroups(list, workspaces, archivedSessionIds, pendingInteractions, view).map((group) => group.expanded ? {
				...group,
				forest: forestOf(group.sessions, byId, archived, descendants, pendingInteractions)
			} : group);
		}
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/var/lib/agent-files/repos/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".YvHw6q_projectRow,.YvHw6q_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.YvHw6q_projectRow:hover,.YvHw6q_sessionRow:hover,.YvHw6q_sessionRow.YvHw6q_selected{background:var(--dsw-alias-interactive-bg-hover)}.YvHw6q_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.YvHw6q_searchResultRow:hover,.YvHw6q_searchResultRow.YvHw6q_selected{background:var(--dsw-alias-interactive-bg-hover)}.YvHw6q_searchResultHeading{align-items:center;min-width:0;display:flex}.YvHw6q_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.YvHw6q_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.YvHw6q_searchResultWorkspace,.YvHw6q_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.YvHw6q_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.YvHw6q_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.YvHw6q_projectRow{box-sizing:border-box;align-items:center;height:34px}.YvHw6q_projectRow .YvHw6q_rowActions{height:20px}.YvHw6q_sessionRow{height:32px;animation:YvHw6q_row-in .15s var(--ds-ease-in-out);gap:0}.YvHw6q_sessionRow .YvHw6q_title{margin:0 6px 0 4px}.YvHw6q_flatSessionRowWithoutStatus .YvHw6q_title{margin-left:0}@keyframes YvHw6q_row-in{0%{opacity:0}}.YvHw6q_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.YvHw6q_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.YvHw6q_folderActive{color:var(--dsw-alias-state-business-primary)}.YvHw6q_projectRow .YvHw6q_chevron{display:none}.YvHw6q_projectRow:hover .YvHw6q_chevron{display:inline-flex}.YvHw6q_projectRow:hover .YvHw6q_folder{display:none}.YvHw6q_arrow{transition:transform .15s var(--ds-ease-in-out)}.YvHw6q_arrowOpen{transform:rotate(90deg)}.YvHw6q_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.YvHw6q_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.YvHw6q_renameInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.YvHw6q_sessionRow .YvHw6q_title{flex:1}.YvHw6q_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.YvHw6q_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.YvHw6q_scheduleIndicator{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex}.YvHw6q_searchScheduleIndicator{margin-left:4px;margin-right:0}.YvHw6q_dot{flex:none}.YvHw6q_rowActions{flex:none;align-items:center;gap:12px;display:none}.YvHw6q_projectRow:hover .YvHw6q_rowActions,.YvHw6q_sessionRow:hover .YvHw6q_rowActions,.YvHw6q_projectRow.YvHw6q_menuOpen .YvHw6q_rowActions,.YvHw6q_sessionRow.YvHw6q_menuOpen .YvHw6q_rowActions{display:inline-flex}.YvHw6q_sessionRow:hover .YvHw6q_time,.YvHw6q_sessionRow.YvHw6q_menuOpen .YvHw6q_time{display:none}.YvHw6q_projectRow.YvHw6q_menuOpen,.YvHw6q_sessionRow.YvHw6q_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.YvHw6q_sessionRow.YvHw6q_dropBefore,.YvHw6q_sessionRow.YvHw6q_dropAfter{position:relative}.YvHw6q_sessionRow.YvHw6q_dropBefore:before,.YvHw6q_sessionRow.YvHw6q_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.YvHw6q_sessionRow.YvHw6q_dropBefore:before{top:-7px}.YvHw6q_sessionRow.YvHw6q_dropAfter:after{bottom:-7px}.YvHw6q_hoverContent{flex-direction:column;gap:8px;display:flex}.YvHw6q_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.YvHw6q_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.YvHw6q_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.YvHw6q_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.YvHw6q_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.YvHw6q_iconButton:hover{color:var(--dsw-alias-label-primary)}.YvHw6q_chevron{color:var(--dsw-alias-label-caption)}.YvHw6q_forkIndent{width:var(--fork-indent,16px);flex:none;height:20px}.YvHw6q_forkTwist{--dsh-state-ongoing:var(--dsw-static-deepseek-450)}.YvHw6q_forkTwistPrimary{color:var(--dsw-alias-state-warn-primary)}.YvHw6q_forkTwistOngoing{color:var(--dsh-state-ongoing)}.YvHw6q_forkTwistDone{color:var(--dsw-alias-state-success-primary)}.YvHw6q_forkTwistError{color:var(--dsw-alias-state-error-primary)}.YvHw6q_forkTwistOngoing>svg{animation:1.2s ease-in-out infinite YvHw6q_fork-twist-breathe}@keyframes YvHw6q_fork-twist-breathe{50%{opacity:.25}}@media (prefers-reduced-motion:reduce){.YvHw6q_sessionRow,.YvHw6q_arrow,.YvHw6q_forkTwistOngoing>svg{transition:none;animation:none}}";
		const tagId$2 = "@deepseek-ai/dsh-client-ui-forkspace/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-forkspace";
		...
		var Rows_module_css_default = {
			"arrow": "YvHw6q_arrow",
			"arrowOpen": "YvHw6q_arrowOpen",
			"chevron": "YvHw6q_chevron",
			"dot": "YvHw6q_dot",
			"dropAfter": "YvHw6q_dropAfter",
			"dropBefore": "YvHw6q_dropBefore",
			"flatSessionRowWithoutStatus": "YvHw6q_flatSessionRowWithoutStatus",
			"folder": "YvHw6q_folder",
			"folderActive": "YvHw6q_folderActive",
			"fork-twist-breathe": "YvHw6q_fork-twist-breathe",
			"forkIndent": "YvHw6q_forkIndent",
			"forkTwist": "YvHw6q_forkTwist",
			"forkTwistDone": "YvHw6q_forkTwistDone",
			"forkTwistError": "YvHw6q_forkTwistError",
			"forkTwistOngoing": "YvHw6q_forkTwistOngoing",
			"forkTwistPrimary": "YvHw6q_forkTwistPrimary",
			"hoverContent": "YvHw6q_hoverContent",
			"hoverPath": "YvHw6q_hoverPath",
			"hoverStatus": "YvHw6q_hoverStatus",
			"hoverTime": "YvHw6q_hoverTime",
			"hoverTitle": "YvHw6q_hoverTitle",
			"iconButton": "YvHw6q_iconButton",
			"menuOpen": "YvHw6q_menuOpen",
			"meta": "YvHw6q_meta",
			"projectRow": "YvHw6q_projectRow",
			"projectText": "YvHw6q_projectText",
			"renameInput": "YvHw6q_renameInput",
			"row-in": "YvHw6q_row-in",
			"rowActions": "YvHw6q_rowActions",
			"scheduleIndicator": "YvHw6q_scheduleIndicator",
			"searchResultHeading": "YvHw6q_searchResultHeading",
			"searchResultMeta": "YvHw6q_searchResultMeta",
			"searchResultRow": "YvHw6q_searchResultRow",
			"searchResultSnippet": "YvHw6q_searchResultSnippet",
			"searchResultTitle": "YvHw6q_searchResultTitle",
			"searchResultWorkspace": "YvHw6q_searchResultWorkspace",
			"searchScheduleIndicator": "YvHw6q_searchScheduleIndicator",
			"selected": "YvHw6q_selected",
			"sessionRow": "YvHw6q_sessionRow",
			"slot": "YvHw6q_slot",
			"time": "YvHw6q_time",
			"title": "YvHw6q_title",
			"visuallyHidden": "YvHw6q_visuallyHidden"
		};
		//#endregion
		...
		*/
		function forkTwistClass(state, showStatus) {
			if (!showStatus) return "";
			switch (state) {
				case "warning": return Rows_module_css_default.forkTwistPrimary;
				case "ongoing": return Rows_module_css_default.forkTwistOngoing;
				case "done": return Rows_module_css_default.forkTwistDone;
				/* v8 ignore next -- ui-workspace statuses never reach error; red stays for parity */
				case "error": return Rows_module_css_default.forkTwistError;
			}
		}
		...
		*/
		function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, drag, flat = false, children, depth, treeCollapsed = false, onToggleTree, t }) {
			const row = node;
			...
			const [menuOpen, setMenuOpen] = (0, react.useState)(false);
			const forkChildren = children !== void 0 && children.length > 0;
			const replaceable = children === void 0 ? void 0 : { collapsed: treeCollapsed };
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
				anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					...replaceable !== void 0 ? {
						role: "treeitem",
						"aria-expanded": !replaceable.collapsed
					} : {},
					onClick: () => {
						onOpen(node.id);
						if (!selected) onToggleTree?.(node.id);
					},
					draggable: drag !== void 0,
					onDragStart: drag === void 0 ? void 0 : (e) => {
						e.dataTransfer.effectAllowed = "move";
					...
					children: [
						depth !== void 0 && depth > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: Rows_module_css_default.forkIndent,
							style: { ["--fork-indent"]: `calc(${depth} * var(--fork-indent-unit, 16px))` }
						}),
						forkChildren ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: clsx(Rows_module_css_default.slot, Rows_module_css_default.chevron, Rows_module_css_default.forkTwist, forkTwistClass(primaryStatus.state, showStatus)),
							onClick: (e) => {
								e.stopPropagation();
								onToggleTree?.(node.id);
							},
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTriangleRightFill14, { className: clsx(Rows_module_css_default.arrow, !treeCollapsed && Rows_module_css_default.arrowOpen) }), showStatus && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: Rows_module_css_default.visuallyHidden,
								children: primaryStatus.label
							})]
		...
		*/
		function SessionTreeNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, depth = 0, foldedIds, onToggle, drag, t }) {
			const hasChildren = node.children.length > 0;
			const collapsed = foldedIds?.has(node.id) === true;
			/**
			...
			*/
			const renderChildren = (children, level) => children.map((child) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionTreeNodeItem, {
				node: child,
				currentId,
				now,
				onOpen,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionNodeItem, {
				node,
				currentId,
				now,
				onOpen,
				...
				drag: depth === 0 ? drag : void 0,
				t
			}), hasChildren && !collapsed && renderChildren(node.children, depth + 1)] });
		}
		//#endregion
		//#region \0dsh-css:/var/lib/agent-files/repos/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".S-FWwG_modalAction{min-width:72px}.S-FWwG_modalError,.S-FWwG_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.S-FWwG_modalError{color:var(--dsw-alias-state-error-primary)}.S-FWwG_menuStatus{color:var(--dsw-alias-label-secondary)}";
		const tagId$1 = "@deepseek-ai/dsh-client-ui-forkspace/WorkspacePicker.module.css";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "S-FWwG_menuStatus",
			"modalAction": "S-FWwG_modalAction",
			"modalError": "S-FWwG_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/var/lib/agent-files/repos/deepseek-harness/packages/client/ui-workspace/src/client/rows/WorkspaceBrowser.module.css.mjs
		const css = ".vvNHna_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.vvNHna_root.vvNHna_rail{padding-right:0}.vvNHna_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.vvNHna_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.vvNHna_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.vvNHna_root:not(.vvNHna_rail) .vvNHna_sectionHeader{margin-top:2px;margin-right:-4px}.vvNHna_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.vvNHna_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.vvNHna_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.vvNHna_searchSlotExpanded{max-width:100%;padding-left:0}.vvNHna_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.vvNHna_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.vvNHna_search{box-sizing:border-box;corner-shape:round;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.vvNHna_searchExpanded{border:.5px solid var(--dsw-alias-border-l4);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.vvNHna_searchButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.vvNHna_searchExpanded .vvNHna_searchButton{width:28px;height:30px}.vvNHna_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.vvNHna_searchExpanded .vvNHna_searchButton:hover{background:0 0}.vvNHna_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.vvNHna_searchExpanded .vvNHna_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.vvNHna_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.vvNHna_clearButton{corner-shape:round;cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.vvNHna_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.vvNHna_rail .vvNHna_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.vvNHna_rail .vvNHna_headerActions{max-width:none}.vvNHna_rail .vvNHna_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.vvNHna_rail .vvNHna_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.vvNHna_rail .vvNHna_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.vvNHna_rail .vvNHna_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.vvNHna_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.vvNHna_rail .vvNHna_listArea{margin-left:0;margin-right:0;padding-left:0}.vvNHna_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.vvNHna_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.vvNHna_wide{animation:vvNHna_wide-in .2s var(--ds-ease-in-out)}@keyframes vvNHna_wide-in{0%{opacity:0}}.vvNHna_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.vvNHna_flatList>*+*,.vvNHna_searchTree>[role=treeitem]+[role=treeitem],.vvNHna_groupSection>*+*{margin-top:2px}.vvNHna_searchStatus,.vvNHna_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.vvNHna_searchWarning{color:var(--dsw-alias-label-secondary)}.vvNHna_groupSection{position:relative}.vvNHna_groupSection+.vvNHna_groupSection{margin-top:4px}.vvNHna_listTopDropIndicator,.vvNHna_workspaceDropBefore:before,.vvNHna_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.vvNHna_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.vvNHna_listTopDropActive>.vvNHna_workspaceDropBefore:first-child:before{display:none}.vvNHna_workspaceDropBefore:before{top:-8px}.vvNHna_workspaceDropAfter:after{bottom:-8px}.vvNHna_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.vvNHna_groupSection>.vvNHna_sessionOverflowButton{margin-top:0}.vvNHna_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.vvNHna_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.vvNHna_renameInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.vvNHna_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.vvNHna_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.vvNHna_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.vvNHna_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.vvNHna_wide{animation:none}.vvNHna_search,.vvNHna_sectionLabel,.vvNHna_searchSlot,.vvNHna_searchInput,.vvNHna_headerActions{transition:none}}";
		const tagId = "@deepseek-ai/dsh-client-ui-forkspace/WorkspaceBrowser.module.css";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "vvNHna_clearButton",
			"deleteAction": "vvNHna_deleteAction",
			"deleteStatus": "vvNHna_deleteStatus",
			"empty": "vvNHna_empty",
			"fade": "vvNHna_fade",
			"flatList": "vvNHna_flatList",
			"groupSection": "vvNHna_groupSection",
			"headerActions": "vvNHna_headerActions",
			"headerActionsHidden": "vvNHna_headerActionsHidden",
			"iconButton": "vvNHna_iconButton",
			"list": "vvNHna_list",
			"listArea": "vvNHna_listArea",
			"listTopDropActive": "vvNHna_listTopDropActive",
			"listTopDropIndicator": "vvNHna_listTopDropIndicator",
			"rail": "vvNHna_rail",
			"renameError": "vvNHna_renameError",
			"renameInput": "vvNHna_renameInput",
			"root": "vvNHna_root",
			"search": "vvNHna_search",
			"searchButton": "vvNHna_searchButton",
			"searchExpanded": "vvNHna_searchExpanded",
			"searchInput": "vvNHna_searchInput",
			"searchSlot": "vvNHna_searchSlot",
			"searchSlotExpanded": "vvNHna_searchSlotExpanded",
			"searchStatus": "vvNHna_searchStatus",
			"searchTree": "vvNHna_searchTree",
			"searchWarning": "vvNHna_searchWarning",
			"sectionHeader": "vvNHna_sectionHeader",
			"sectionLabel": "vvNHna_sectionLabel",
			"sectionLabelHidden": "vvNHna_sectionLabelHidden",
			"sessionOverflowButton": "vvNHna_sessionOverflowButton",
			"treeBody": "vvNHna_treeBody",
			"wide": "vvNHna_wide",
			"wide-in": "vvNHna_wide-in",
			"workspaceDropAfter": "vvNHna_workspaceDropAfter",
			"workspaceDropBefore": "vvNHna_workspaceDropBefore"
		};
		//#endregion
		...
		*/
		...
		function countForestRows(nodes) {
			let total = 0;
		...
		*/
		function collapsedForestRows(forest) {
			...
			const walk = (nodes) => {
				...
				for (const node of nodes) {
					...
					kept.push(children.length === node.children.length ? node : {
						...node,
						children
					});
				}
			...
			return {
				rows,
				hiddenCount: countForestRows(forest) - countForestRows(rows)
			};
		}
		...
		*/
		...
		function SessionTree({ useSessions, useSessionPendingInteraction, startSession, open, forkSession, workspaces, archivedSessionIds, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, insertWorkspaceBefore, insertSessionBefore, orderBy, groupExpansion, setGroupExpanded, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, home, t }) {
			...
			const [collapsedTreeRows, setCollapsedTreeRows] = (0, react.useState)([]);
			...
			const forests = (0, react.useMemo)(() => {
				const map = /* @__PURE__ */ new Map();
				const derived = deriveGroupForest(list, orderedWorkspaces, archivedSessionIds, pendingInteractions, {
					expandedGroups,
					...sessionOrderByAccount[""] === void 0 ? {} : { ungroupedOrder: sessionOrderByAccount[""] }
				});
				for (const group of derived) if (group.forest !== void 0) map.set(group.key, group.forest);
				return map;
			}, [
				list,
				orderedWorkspaces,
			...
			(0, react.useEffect)(() => {
				...
				for (const forest of forests.values()) if (walk(forest, [])) break;
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [groups.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							const clippedTreeIds = /* @__PURE__ */ new Set();
							if (!sessionsExpanded) {
								const collect = (nodes, kept) => {
									for (let i = 0; i < nodes.length; i += 1) {
										const node = nodes[i];
										const keptNode = kept[i];
										if (node === void 0 || keptNode === void 0) continue;
										if (node.children.length > 0 && keptNode.children.length === 0) clippedTreeIds.add(node.id);
							...
							const onToggleTree = (id) => {
								if (clippedTreeIds.has(id)) return;
								setCollapsedTreeRows((keys) => toggled(keys, id));
							};
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									forestRows.map((node) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionTreeNodeItem, {
											node,
											currentId: current,
											now,
											onOpen: open,
									...
									(sessionsExpanded ? preview.hiddenCount : collapsed.hiddenCount) > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										...
										children: sessionsExpanded ? t("sessions.collapse") : t("sessions.expand", { n: preview.hiddenCount })
									})
								]
							}, group.key);
						})]
