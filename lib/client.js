	...
	factory: (require) => {
		...
		*/
		...
		var Rows_module_css_default = {
			...
			"forkChild": "YvHw6q_forkChild",
			"forkSlot": "YvHw6q_forkSlot",
		...
		*/
		function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, drag, flat = false, children, treeCollapsed = false, onToggleTree, t }) {
			const row = node;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
				anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						children !== void 0 && children.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: clsx(Rows_module_css_default.slot, Rows_module_css_default.forkSlot),
						...
						children !== void 0 && children.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: Rows_module_css_default.slot }),
		...
		*/
		function SessionTreeNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, depth = 0, collapsed = false, onToggle, drag, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: depth > 0 ? Rows_module_css_default.forkChild : void 0,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionNodeItem, {
					node,
					currentId,
					now,
					onOpen,
					...
					onToggleTree: hasChildren ? onToggle : void 0,
					drag: depth === 0 ? drag : void 0,
					t
				})
			}), hasChildren && !collapsed && node.children.map((child) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionTreeNodeItem, {
				node: child,
				currentId,
				now,
				onOpen,
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [groups.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							const collapsedTreeIds = /* @__PURE__ */ new Set();
							if (!sessionsExpanded) {
								const collect = (nodes, kept) => {
									for (let i = 0; i < nodes.length; i += 1) {
										...
										if (node.children.length > 0 && keptNode.children.length === 0) collapsedTreeIds.add(node.id);
								...
								children: [
									...
									forestRows.map((node) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionTreeNodeItem, {
											...
											collapsed: collapsedTreeIds.has(node.id) || collapsedTreeRows.includes(node.id),
		...
		*/
		...
		const zh = {
			...
			"sessions.twist.expand": "展开分支会话",
			"sessions.twist.collapse": "收起分支会话",
			"empty.none": "暂无会话",
		...
		const en = {
			...
			"sessions.twist.expand": "Expand fork children",
			"sessions.twist.collapse": "Collapse fork children",
