	...
	factory: (require) => {
		...
		*/
		function deriveGroupForest(list, workspaces, archivedSessionIds, pendingInteractions, view) {
			...
			for (const g of groupByWorkspace(list, workspaces, archived, view.ungroupedOrder)) {
				const expanded = expandedGroups.has(g.key);
				const rootHuman = (startId) => {
					let cur = startId;
					for (let hops = 0; hops < 1024 && cur !== void 0; hops++) {
						const rec = list.byId[cur];
				...
				const humanParent = /* @__PURE__ */ new Map();
				for (const s of g.sessions) {
					if (s.origin === "subagent" || s.parentId === void 0 || s.parentId === s.id) continue;
					const anc = rootHuman(s.parentId);
					if (anc !== void 0 && anc !== s.id) humanParent.set(s.id, anc);
				}
				...
				const build = (id) => {
					...
					const kids = (childrenOf.get(id) ?? []).map(build).filter((n) => n !== void 0).sort((a, b) => a.updatedAt === b.updatedAt ? a.id < b.id ? -1 : 1 : a.updatedAt < b.updatedAt ? 1 : -1);
					return {
						...nodeOf(s),
						children: kids
					};
				...
				const forest = g.sessions.filter((row) => row.origin !== "subagent" && !childIds.has(row.id)).map((row) => build(row.id)).filter((n) => n !== void 0);
				groups.push({
					key: g.key,
					workspaceId: g.workspaceId,
					cwd: g.cwd,
		...
		*/
		...
		var Rows_module_css_default = {
			...
			"meta": "YvHw6q_meta",
			"nodeCaret": "YvHw6q_nodeCaret",
			"nodeCaretOpen": "YvHw6q_nodeCaretOpen",
			"nodeCaretSpacer": "YvHw6q_nodeCaretSpacer",
			"nodeChildren": "YvHw6q_nodeChildren",
			...
			"sessionTreeBlock": "YvHw6q_sessionTreeBlock",
			"slot": "YvHw6q_slot",
			"time": "YvHw6q_time",
			"title": "YvHw6q_title",
			"treeRow": "YvHw6q_treeRow",
		...
		*/
		function SessionTreeNodeItem({ node, now, currentId, collapsed, onToggle, onOpen, onRename, onFork, onArchive, t, drag }) {
			const hasKids = node.children.length > 0;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: Rows_module_css_default.sessionTreeBlock,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: Rows_module_css_default.treeRow,
					children: [hasKids ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						"aria-label": collapsed ? "Expand" : "Collapse",
						"aria-expanded": !collapsed,
						className: clsx(Rows_module_css_default.nodeCaret, !collapsed && Rows_module_css_default.nodeCaretOpen),
						onClick: (e) => {
							e.stopPropagation();
							onToggle(node.id);
						},
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTriangleRightFill14, {})
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: Rows_module_css_default.nodeCaretSpacer }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionNodeItem, {
						node,
						currentId,
						now,
						onOpen,
				...
				}), !collapsed && node.children.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: Rows_module_css_default.nodeChildren,
					children: node.children.map((child) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionTreeNodeItem, {
						node: child,
						now,
						currentId,
						collapsed: false,
		...
		*/
		...
		function SessionTree({ useSessions, useSessionPendingInteraction, startSession, open, forkSession, workspaces, archivedSessionIds, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, insertWorkspaceBefore, insertSessionBefore, orderBy, groupExpansion, setGroupExpanded, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, home, t }) {
			...
			const [collapsedNodes, setCollapsedNodes] = (0, react.useState)(() => /* @__PURE__ */ new Set());
						...
						children: [groups.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									sessionsExpanded ? (forests.get(group.key) ?? []).map((root) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionTreeNodeItem, {
											...
											onToggle: (id) => setCollapsedNodes((prev) => {
